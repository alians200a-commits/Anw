# Daleeli — approved animated icon mapping

Selection rule: best semantically accurate IconScout medical Lottie → Flaticon medical animated fallback when needed. Medical Animation Pack 197672 remains preferred when it contains the right visual, but it is not mandatory if a more precise IconScout medical animation exists.
...
| terms | المصطلحات | Health Question | 7140720 | Flaticon Medical Record animated |
| abbreviations | الاختصارات | Health Record / text-oriented medical record | 7140721 | Flaticon Text Box animated |

## Primary source pages

- Home: https://iconscout.com/lottie-animation/mobile-health-app-animation_7140714
- Guide — Medical Record: https://iconscout.com/lottie-animation/medical-record-animation_10435818
- Learn: https://iconscout.com/lottie-animation/microscope-animation_7140713
...
- Terms: https://iconscout.com/lottie-animation/health-question-animation_7140720
- Flaticon medical animated fallback collection: https://www.flaticon.com/free-animated-icons/medical

## Integration lock

- Do not hotlink IconScout preview media.
- Import IconScout assets only after an authorized download through the user's IconScout account/license.
- Prefer local project assets after download.
- Never loop forever. Play once on entry/press/open, then stop.
