        ...
        <div className="overflow-hidden rounded-[18px] border border-[#CCA039]/10 bg-[#0D2741]">
          ...
          {openMenu === 'guide' && (
            <div className="border-t border-white/5 px-2 py-2">
              ...
              <button onClick={() => openGuide('fluids')} className="flex w-full items-center justify-between rounded-xl px-2.5 py-2.5 active:bg-white/[0.03]">
                <CaretLeft size={15} className="text-[#5F7488]" />
                <div className="flex items-center gap-3">
                  <span className="text-xs font-bold text-[#DDE2E6]">السوائل الوريدية</span>
                  <Drop size={20} weight="fill" className="text-[#CCA039]" />
                </div>
              </button>
