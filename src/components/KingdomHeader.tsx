      ...
      <div className="mx-auto grid min-h-[108px] max-w-3xl grid-cols-[72px_1fr_72px] items-center px-4 py-3">
        ...
        <div className="flex flex-col items-center justify-center gap-[10px] text-center">
          <h1
            dir="rtl"
            lang="ar"
            className="font-mohawla-brand whitespace-nowrap text-[30px] leading-[1.12] text-white"
          >
            دليلي
          </h1>
          <p
            dir="rtl"
            lang="ar"
            className="font-mohawla-brand whitespace-nowrap text-[24px] leading-[1.12] text-[#CCA039]" style={{ wordSpacing: '0.16em' }}
          >
            مملكة التخدير
          </p>
        </div>
