...
export const CLINICAL_GUIDES: ClinicalGuide[] = [
    ...
    sections: [
      {
        ...
        items: [
          ...
          'المرحلة III - التخدير الجراحي | Stage III - Surgical anesthesia: تخدير جراحي مع ارتخاء عضلي متزايد؛ وُصفت تاريخيًا بأربع planes بحسب حركة العين والمنعكسات والتنفس.',
...

  {
    ...
    titleAr: 'التحريض الوريدي',
    titleEn: 'Intravenous Induction',
    category: 'general',
    categoryAr: 'التخدير العام',
    sourcePages: [61,73],
    summary: 'تحريض التخدير العام بإعطاء عامل منوم وريدي | Intravenous induction agent للوصول سريعًا إلى فقدان الوعي مع مراقبة مجرى الهواء والتنفس والدورة الدموية.',
    sections: [
      {
      ...
      },
      {
        ...
        items: [
          'بدء سريع | Rapid onset، وغالبًا أسرع من التحريض الاستنشاقي.',
          'يجتاز مرحلة الإثارة | Excitement بسرعة أكبر عادةً.',
          'لا يحتاج إلى مبخر | Vaporizer لبدء التحريض.',
...

  {
    ...
    categoryAr: 'التخدير العام',
    sourcePages: [32,60],
    summary: 'تحريض التخدير العام باستنشاق عامل متطاير | Volatile anesthetic، ويُستخدم خصوصًا عندما يكون البدء الوريدي غير مناسب أو عندما نريد الحفاظ على التنفس التلقائي في حالات مختارة.',
    sections: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          'طريقة شائعة ومريحة نسبيًا في الأطفال عندما يكون تركيب IV قبل التحريض صعبًا.',
      ...
      },
      {
        ...
        items: [
          'غالبًا أبطأ من التحريض الوريدي، لذلك قد تطول مرحلة الإثارة | Excitement بدرجة أكبر.',
      ...
      },
      {
        ...
        items: [
          ...
          'وجود مرض تنفسي ليس مانعًا مطلقًا لكل تحريض استنشاقي؛ القرار يعتمد على نوع المرض، نشاطه، خطر تهيج مجرى الهواء والعامل المستخدم.'
        ]
      }
    ],
