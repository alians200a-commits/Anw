...
export const CLINICAL_GUIDES: ClinicalGuide[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: 'صلة ذلك بالتخدير الحديث | Modern relevance',
        items: [
          'يذكر المصدر أن البدء الوريدي السريع يختصر المرور بمرحلة الإثارة مقارنةً بالبدء الاستنشاقي التاريخي؛ عمليًا لا نستخدم رقم 10–20 ثانية كقاعدة لكل دواء ومريض.',
          'التخدير المتوازن الحديث، والمرخيات العضلية والمراقبة الحالية تجعل علامات Guedel أقل موثوقية لتقدير العمق منفردة.'
        ]
      }
    ],
...

  {
    ...
    sections: [
      ...
      {
        title: 'صفات العامل الوريدي المثالي | Ideal IV agent',
        items: [
          'المصدر يضع هذه الصفات كقائمة مثالية تعليمية، وليس كدواء موجود يحققها كلها.',
          'قوة دوائية جيدة تسمح بحجم حقن صغير | Potent / small injection volume.',
          'بدء وإفاقة سريعتان وسلسان | Rapid, smooth onset and recovery.',
          'ثبات كيميائي وفترة صلاحية جيدة، مع سهولة التحضير والتوافق مع السوائل/الأدوية المناسبة.',
          'لا يسبب حساسية، ولا تثبيطًا قلبيًا أو تنفسيًا مهمًا، ولا تأثيرًا ضارًا على CBF/ICP/IOP أو الغدد الصماء.',
          'لا يعتمد التخلص منه بصورة كبيرة على الكبد أو الكلى، ويُفضّل أن يكون تأثيره قابلًا للعكس بعامل محدد.',
          'قليل ألم الحقن والتهاب الوريد وأذية التسرب خارج الوريد أو الحقن داخل الشريان.',
          'لا يسبب حركة غير مرغوبة أو سعالًا أو فواقًا، ويكون منخفض الكلفة وسهل الاستخدام.'
        ]
      },
      {
    ...
    sections: [
      {
        ...
        items: [
          'بعد جرعة واحدة من كثير من عوامل البدء الوريدية يستمر فقدان الوعي عادةً دقائق محدودة؛ لذلك يلزم الانتقال إلى خطة إدامة للحفاظ على التخدير طوال مدة الجراحة.',
          'يمكن تحقيق الإدامة باستنشاق خليط مضبوط من الأوكسجين مع عامل متطاير | Volatile anesthetic، مع أو بدون Nitrous oxide بحسب الخطة والحالة.',
          'يمكن أيضًا استخدام تخدير وريدي كلي | Total intravenous anesthesia (TIVA)، وغالبًا يعتمد على تسريب Propofol مع المسكنات المناسبة دون الحاجة إلى عامل استنشاقي.',
          'تسكين إضافي | Analgesia مثل الأفيونات | Opioids حسب الحاجة، وقد تُستخدم مهدئات أو عوامل وريدية مساعدة ضمن Balanced anesthesia.',
          'مرخيات عضلية | Neuromuscular blockers إذا تطلبت الجراحة ذلك، مع المراقبة المناسبة للحصار العصبي العضلي.',
          ...
          'عند نهاية الجراحة تُخفض أو تُوقف عوامل التخدير تدريجيًا، وتبدأ الإفاقة عندما ينخفض تأثيرها في الجهاز العصبي المركزي إلى مستوى يسمح بعودة الوعي والتهوية والاستقرار.'
        ]
      }
    ],
    ...
    sections: [
      {
        ...
        items: [
          'يوضع IV cannula في الطرف المراد تخديره، وغالبًا يذكر المصدر ظهر اليد لإجراءات الطرف العلوي.',
          'يُفرّغ الطرف من الدم بالرفع ثم بضماد Esmarch عند ملاءمته | Limb exsanguination؛ المصدر يذكر الرفع لنحو 5 دقائق كخطوة تقليدية.',
          'تُستخدم عاصبة هوائية، وغالبًا Double-cuff tourniquet. المصدر يذكر نفخ الكفة العلوية لنحو 50 mmHg فوق الضغط الانقباضي؛ عمليًا يُستخدم ضغط يكفي لإيقاف الجريان الشرياني وفق الطرف والجهاز والبروتوكول.',
          'يُحقن مخدر موضعي مخفف خالٍ من Epinephrine؛ المصدر يذكر 25–50 mL من محلول مخفف، لكن الجرعة الحديثة تُحسب بالـmg/kg وبالحد السمي لا بالحجم وحده.',
          'بعد بدء الحصار يمكن استخدام الكفة البعيدة لتقليل ألم العاصبة؛ المصدر يصف نقل الضغط إليها بعد نحو 5–10 دقائق.'
        ]
      },
      {
        title: 'العاصبة والسلامة | Tourniquet safety',
        items: [
          'لا تُفرغ العاصبة مبكرًا بعد حقن المخدر الموضعي؛ التوقيت وطريقة التفريغ يعتمدان على مدة الإجراء والبروتوكول لتقليل اندفاع المخدر إلى الدوران.',
          'المصدر يذكر حدًا تعليميًا تقليديًا يقارب ساعة واحدة للعاصبة؛ عمليًا مدة العاصبة تُدار حسب الطرف والضغط والجراحة والبروتوكول، مع تقليل زمنها قدر الإمكان.',
    ...
    sections: [
      {
        ...
        items: [
          ...
          'المصدر يذكر عمقًا تعليميًا يقارب 6 cm للوصول إلى الحيز تحت العنكبوتية؛ هذا ليس رقمًا ثابتًا ويختلف بوضوح مع البنية الجسمية والوضعية والتشريح.'
        ]
      },
      {
    ...
    sections: [
      {
        ...
        items: [
          ...
          'تُمرر قسطرة فوق الجافية | Epidural catheter عدة سنتيمترات داخل الحيز ثم تُسحب الإبرة وتُثبت القسطرة؛ المصدر يذكر نطاقًا تقليديًا 2–5 cm داخل الحيز.',
          'بعد aspiration السلبي يمكن استخدام Test dose لاكتشاف الوضع داخل الوعاء أو داخل السحايا؛ المصدر يذكر 3 mL Lidocaine 1.5% مع Epinephrine 1:200,000 والانتظار نحو 3 دقائق، لكن التركيبة والتوقيت ليسا بروتوكولًا عالميًا واحدًا ويُفردان حسب المريض والممارسة.'
        ]
      },
      {
...

  {
    ...
    sections: [
      ...
      {
        title: 'نموذج الحيزين | Compartment model',
        items: [
          'الحيز المركزي | Central compartment أصغر حجمًا ويشمل الدم والبلازما والأعضاء عالية التروية مثل القلب والرئتين والكلى والكبد.',
          'مع مرور الوقت ينتقل الدواء إلى الحيز الطرفي | Peripheral compartment الذي يضم أنسجة ومواقع أخرى أقل تروية نسبيًا.',
          'الانتقال بين الحيزين يساعد على فهم التوزيع وإعادة التوزيع | Distribution / redistribution بعد الحقن الوريدي.'
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          'يذكر المصدر ثلاثة محددات رئيسية لانتقال الدواء من البلازما إلى الأنسجة بعد الإعطاء الوريدي: الارتباط ببروتينات البلازما | Plasma protein binding، درجة التأين | Degree of ionization، والذوبان الدهني | Lipid solubility.',
          'الدواء شديد الارتباط بالبروتين أو عالي التأين أو قليل الذوبان في الدهون يميل نسبيًا إلى البقاء أكثر داخل البلازما بدل عبور الأغشية إلى الأنسجة.',
          'الكلى هي الطريق الرئيسي لإطراح كثير من الأدوية أو مستقلباتها القابلة للذوبان في الماء، بينما يقوم الكبد بالدور الأكبر في استقلاب كثير من الأدوية وتحويلها إلى مركبات أسهل للإطراح.',
          'الأدوية القابلة للذوبان في الدهون قد تُعاد امتصاصها بسهولة أكبر في الأنابيب الكلوية؛ لذلك يساعد الاستقلاب على جعل كثير منها أكثر قابلية للذوبان في الماء قبل الإطراح.',
    ...
    sections: [
      {
        ...
        items: [
          ...
          'المصدر يذكر تاريخيًا فرضية تغيير توافر الناقل العصبي | Alteration in neurotransmitter availability، مع التركيز على GABA كناقل مثبط. نحفظها كمفهوم تاريخي، بينما الفهم الحديث هو تعديل مستقبلات وقنوات وشبكات متعددة وليس “استقلاب GABA” وحده.'
        ]
      },
      {
  ...
  },
  {
    ...
    sections: [
      {
        title: 'قيم MAC حسب العمر | Age-adjusted MAC reference',
        items: [
          'Halothane: عمر 1 سنة ≈ 0.95% | عمر 40 سنة ≈ 0.75% | عمر 80 سنة ≈ 0.58%.',
          'Isoflurane: عمر 1 سنة ≈ 1.49% | عمر 40 سنة ≈ 1.17% | عمر 80 سنة ≈ 0.91%.',
          'Enflurane: عمر 1 سنة ≈ 2.08% | عمر 40 سنة ≈ 1.63% | عمر 80 سنة ≈ 1.27%.',
          'Sevoflurane: عمر 1 سنة ≈ 2.29% | عمر 40 سنة ≈ 1.80% | عمر 80 سنة ≈ 1.40%.',
          'Desflurane: عمر 1 سنة ≈ 8.3% | عمر 40 سنة ≈ 6.6% | عمر 80 سنة ≈ 5.1%.',
          'Nitrous oxide: عمر 1 سنة ≈ 133% | عمر 40 سنة ≈ 104% | عمر 80 سنة ≈ 81%؛ القيم فوق 100% تعني أن 1 MAC من N₂O وحده غير قابل للتحقيق عند الضغط الجوي الطبيعي.'
        ]
      },
      {
        title: 'تأثير العمر | Effect of age',
        items: [
          'بعد السنة الأولى تقريبًا تنخفض متطلبات MAC مع العمر بمعدل يقارب 6% لكل عقد من العمر وفق نموذج Mapleson.',
          'القيم المرجعية ليست رقمًا ثابتًا لكل مريض؛ الحرارة والأدوية المصاحبة والحالة الفيزيولوجية تؤثر أيضًا في المتطلب.',
          'Xenon عامل استنشاقي مخدر نادر/مكلف؛ الدراسات البشرية وضعت MAC للبالغين تقريبًا ضمن نطاق 63–71%، لذلك لا نعامله كقيمة واحدة ثابتة أو كعامل روتيني في معظم المؤسسات.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'أحجام تقريبية للبالغين | Typical adult internal diameter: غالبًا 8.0–9.0 mm للذكور و7.0–8.0/8.5 mm للإناث؛ الاختيار النهائي يعتمد على حجم المريض والتشريح ونوع الأنبوب والإجراء.'
        ]
      },
      {
        title: 'الكفة | Cuff',
        items: [
          'تُنفخ الكفة للحصول على إحكام مناسب يسمح بالتهوية بالضغط الإيجابي ويقلل تسرب الغاز حول الأنبوب.',
          'تساعد الكفة على تقليل مرور الإفرازات ومحتويات البلعوم نحو الرغامى، لكنها لا تمنع الاستنشاق الرئوي بصورة مطلقة.',
          'يجب تجنب فرط نفخ الكفة ومراقبة ضغطها عندما يكون ذلك ممكنًا لتقليل أذية مخاطية الرغامى.'
        ]
      },
      {
