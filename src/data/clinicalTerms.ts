...
export const CLINICAL_TERMS: ClinicalTerm[] = [
  ...
  },
  {
    ...
    clinicalNote: 'يمكن أن يكون البدء في التخدير وريديًا | Intravenous أو استنشاقيًا | Inhalational بحسب المريض والخطة؛ لا نعتمد كلمة «تحريض» في التسمية العربية داخل التطبيق.',
