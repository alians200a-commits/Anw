...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'نقص أو خلل Butyrylcholinesterase، وقد يكون وراثيًا أو مكتسبًا',
      'تناول المريض للماء قبل العملية مباشرة',
      'زيادة إفراز الأنسولين من البنكرياس'
    ],
    correctIndex: 1,
    explanation: 'تحدث الحالة عند نقص أو خلل Butyrylcholinesterase المسؤول عن التحلل السريع لـSuxamethonium؛ قد يكون السبب وراثيًا أو مكتسبًا.'
  },
  {
    id: 'q4',
  ...
  },
  {
    ...
    options: [
      ...
      'التركيز السنخي الأدنى الذي يمنع الحركة لدى 50% من المرضى استجابةً لمنبه جراحي معياري',
      'معدل جريان الدم في الشرايين التاجية للقلب',
      'وحدة قياس جرعة السوائل الوريدية'
    ],
    correctIndex: 1,
    explanation: 'MAC هو Minimum Alveolar Concentration: التركيز السنخي لعامل استنشاقي الذي يمنع الحركة لدى 50% من المرضى استجابةً لمنبه جراحي معياري، وهو مقياس لقوة العامل وليس مقياسًا مباشرًا للتسكين أو الوعي.'
  },
  {
    id: 'q6',
    question: 'أي من الاختصارات التالية يشير إلى تدفق الدم الدماغي؟',
    options: [
      'ICP',
      'CBF',
      'MAC',
    ...
    correctIndex: 1,
    explanation: 'CBF = Cerebral Blood Flow (تدفق الدم الدماغي)، بينما ICP = Intracranial Pressure (الضغط داخل القحف).'
  },
  {
    id: 'q7',
