...
export const DRUG_DETAILS: Record<string, DrugDetail> = {
  ...
  sevoflurane: {
    ...
    warnings: ['قد يسبب هبوط الضغط وتثبيط التنفس بشكل يعتمد على التركيز', 'يمكن أن يسبب فرط الحرارة الخبيث لدى المرضى القابلين لذلك، ويزداد القلق عند الجمع مع Succinylcholine في المريض القابل', 'قد يطيل QT لدى المرضى القابلين أو مع أدوية تطيل QT', 'يلزم مراقبة التهوية والدورة الدموية باستمرار'],
  ...
  isoflurane: {
    ...
    contraindications: ['قابلية معروفة أو مشتبه بها لفرط الحرارة الخبيث', 'فرط التحسس لعوامل التخدير الهالوجينية'],
    warnings: ['قد يسبب هبوط الضغط وتثبيط التنفس حسب التركيز، ويكون الحذر أكبر في نقص الحجم أو انخفاض الضغط', 'رائحته لاذعة نسبيًا لذلك لا يُفضّل عادةً لبدء التخدير بالقناع', 'قد يزيد جريان الدم الدماغي ويرفع ICP مؤقتًا عند مستويات أعمق من التخدير', 'يقوّي تأثير المرخيات العصبية العضلية وقد يقلل الجرعة المطلوبة منها أثناء التخدير'],
