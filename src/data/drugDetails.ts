...
export const DRUG_DETAILS: Record<string, DrugDetail> = {
  ...
  etomidate: {
    ...
    correction: 'التأثير الأقل على الضغط ميزة نسبية وليس “لا تأثير على القلب” كما في بعض المذكرات. Etomidate قد يسبب hypotension أقل من بدائل كثيرة لكنه لا يضمن الاستقرار، كما أن adrenal suppression قد يستمر ساعات بعد جرعة التحريض.',
    sourcePages: [68, 70],
  ...
  glycopyrrolate: {
    ...
    educationalDoses: ['FDA preanesthetic adult/pediatric dosing: 0.004 mg/kg IM قبل التحريض بـ30–60 دقيقة عند وجود استطباب.', 'مع Neostigmine لعكس الحصار: 0.2 mg Glycopyrrolate لكل 1 mg Neostigmine حسب الملصق؛ يمكن إعطاؤهما متزامنين IV.'],
