...
export const DRUG_DETAILS: Record<string, DrugDetail> = {
  propofol: {
    ...
    correction: 'المصدر يعرض حساسية البيض/الصويا بصورة واسعة. الملصقات الأمريكية الحديثة تذكر تحديدًا تاريخ التأق | Anaphylaxis للبيض/منتجاته أو الصويا/منتجاتها ضمن الموانع، إضافة إلى الحساسية للبروبوفول أو مكونات المستحضر؛ ولا تُحوّل حساسية غذائية بسيطة تلقائيًا إلى نفس درجة الخطر دون تقييم.',
  ...
  etomidate: {
    ...
    correction: 'التأثير الأقل على الضغط ميزة نسبية وليس “استقرارًا مطلقًا”. كذلك التثبيط الكظري | Adrenal suppression قد يستمر ساعات بعد جرعة التحريض، والتسريب المطول غير مخصص لهذا المستحضر.',
    sourcePages: [68, 70],
  ...
  sevoflurane: {
    ...
    onsetDuration: ['قليل الذوبان نسبيًا في الدم لذلك يسمح بتحريض وإفاقة سريعين نسبيًا | Low blood-gas solubility.'],
    sourcePages: [58, 71],
  ...
  fentanyl: {
    ...
    correction: 'الجرعات العالية أو الحقن السريع قد يسببان تيبسًا عضليًا/جدار الصدر | Chest-wall rigidity، لذلك يلزم الاستعداد لدعم التهوية.',
    sourcePages: [70, 81],
  ...
  remifentanil: {
    ...
    correction: 'زوال التأثير سريع جدًا؛ لا يوفر تسكينًا مستمرًا بعد إيقافه، لذلك يجب تجهيز خطة تسكين بديلة قبل نهاية التسريب.',
    sourcePages: [70],
  ...
  atropine: {
    ...
    correction: 'ليس مطلوبًا روتينيًا لكل مريض قبل التخدير؛ يُستخدم عند استطباب محدد مثل بطء القلب أو مع بعض استراتيجيات عكس الحصار.',
  ...
  adrenaline: {
    ...
    correction: 'طريق وتركيز Adrenaline يختلفان جذريًا حسب الاستطباب؛ التأق يُعالج أساسًا IM، بينما Cardiac arrest يستخدم تركيز/جرعة IV مختلفة. يجب عدم عرض “أدرينالين لرفع الضغط” كقاعدة عامة لكل shock.',
    sourcePages: [71, 105],
