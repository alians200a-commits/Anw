...
export const DRUG_DETAILS: Record<string, DrugDetail> = {
  ...
  thiopental: {
    ...
    warnings: ['قد يسبب هبوط ضغط وتثبيطًا تنفسيًا أو انقطاع النفس', 'الحقن خارج الوريد قد يسبب ألمًا وأذية نسيجية، والحقن داخل الشريان بالخطأ قد يسبب تشنجًا وعائيًا وأذية إقفارية خطرة', 'المحلول قلوي ويجب تحضيره وإعطاؤه وفق المستحضر والبروتوكول', 'لا يُعتمد عليه كمسكن للألم'],
