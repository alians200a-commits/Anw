...
export const ANESTHESIA_EQUIPMENT: AnesthesiaEquipment[] = [
  ...
  },
  {
    ...
    clinicalNote: 'يُستخدم عادةً عند غياب منعكس القيء/البلع. لا يعالج Laryngospasm، وقد يثير القيء أو السعال أو تشنج الحنجرة إذا أُدخل لمريض ما زالت منعكسات مجرى الهواء فعالة.',
  ...
  },
  {
    ...
    clinicalNote: 'الأنبوب ذو الكفة يمكن استخدامه بأمان في الأطفال عند اختيار الحجم وضبط ضغط الكفة؛ القاعدة القديمة «تحت 8 سنوات = uncuffed فقط» غير معتمدة كقاعدة عامة حديثة.',
  ...
  },
  {
    ...
    clinicalNote: 'الـStylet أداة لتشكيل الأنبوب وتوجيهه، ويجب ألا يبرز طرفه خارج نهاية ETT لتجنب أذية مجرى الهواء.',
  ...
  },
  {
    ...
    clinicalNote: 'LMA جهاز فوق المزمار مفيد في حالات مختارة والإنقاذ، لكنه لا يوفر نفس مستوى الحماية من aspiration الذي يوفره ETT ذو الكفة؛ الاختيار يعتمد على الإجراء وخطر الاستنشاق.',
  ...
  },
  {
    ...
    clinicalNote: 'SpO₂ تقدير للأكسجة وليست قياسًا للتهوية. الهدف المقبول والقراءة نفسها يعتمدان على حالة المريض وجودة الإشارة والتروية والحركة والعوامل التي تؤثر في القياس.',
  ...
  },
  {
    ...
    clinicalNote: 'جهاز الشفط يجب أن يكون جاهزًا ومختبرًا قبل بدء التخدير، مع قسطرة مناسبة ويمكن الوصول إليه فورًا. الشفط العميق أو المطول قد يسبب أذية مخاطية، نقص أكسجة أو استجابة مبهمية؛ يُستخدم بالقدر اللازم مع مراقبة المريض.',
