...
export const ANESTHESIA_EQUIPMENT: AnesthesiaEquipment[] = [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      'قد تتوفر أسطوانات لغازات أو خلطات أخرى مثل Medical Air وEntonox وCO₂ بحسب النظام والمؤسسة.',
      'ألوان الأسطوانات وضغوط التعبئة ليست معيارًا عالميًا واحدًا؛ التعرف يعتمد على الملصق والموصلات الخاصة بالغاز.',
      'Cyclopropane عامل تخدير تاريخي شديد القابلية للاشتعال والانفجار وليس غاز تخدير روتينيًا حديثًا.',
  ...
  },
  {
    ...
    keyPoints: [
      'جير الصودا التقليدي | Soda lime يتكون أساسًا من هيدروكسيد الكالسيوم | Ca(OH)₂، تاريخيًا بنحو 95% تقريبًا مع كمية صغيرة من NaOH/KOH وماء ومواد مضافة.',
